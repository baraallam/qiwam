...
/* Computes the financial calculations */
...
function Auth({ t, lang, setLang, onLogin }) {
  ...
  async function submit() {
    ...
    if (mode === "register") {
      ...
      // Login: User can enter username or email, Supabase needs email
      let loginEmail = em;
